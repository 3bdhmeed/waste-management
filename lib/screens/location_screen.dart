...
class _MapScreenState extends State<MapScreen> {
  LatLng userLocation = LatLng(24.0975, 32.8999); // Set to Aswan, Egypt
  ...
  Future<List<Map<String, dynamic>>> loadNodesFromExcel() async {
    ByteData data = await rootBundle.load('assets/NodesPlaces_DS.xlsx');
        ...
        try {
          ...
          showDialog(
            ...
            builder: (context) => AlertDialog(
              ...
              content: Text("Failed to calculate the route. Please try again."),
              actions: [
                TextButton(
